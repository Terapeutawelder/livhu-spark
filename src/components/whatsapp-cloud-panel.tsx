...
import { Loader2, Check, Copy, Trash2, Plug, ExternalLink, AlertTriangle } from "lucide-react";
    ...
    <div className="space-y-4">
      <Card className="p-6">
        ...
        <div className="mb-4 rounded-lg border border-primary/30 bg-primary/5 p-3">
          <p className="text-sm font-medium">Prefere conectar em 1 clique?</p>
          <p className="text-xs text-muted-foreground">
            Use a aba <strong>Conectar canais</strong> — o WhatsApp (e também Instagram, Messenger e Google)
            é conectado pelo login oficial, sem tokens manuais. Esta tela é o modo avançado, para quem já tem
            número aprovado direto na Meta.
          </p>
        </div>
