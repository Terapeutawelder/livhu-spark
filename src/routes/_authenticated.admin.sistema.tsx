        ...
        <div className="rounded-2xl border border-border bg-surface p-5">
          ...
          <div className="mt-4 space-y-4">
            {[
              ...
              { t: "Suporte a Clínicas", d: "Preciso que implente essas funcionalidades do plano para clínicas: Implemente a tela para criar e gerenciar clínicas e suas equipes dentro do meu painel administrativo.\n\nCrie um painel separado para cada profissional dentro da clínica, permitindo personalizar agenda e landing page individualmente e tudo mais.", s: "in_progress" },
