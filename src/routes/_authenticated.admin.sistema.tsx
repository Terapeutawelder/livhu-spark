...
function SystemPage() {
  ...
  return (
    <AdminShell title="Sistema" description="Observabilidade e configuração operacional da plataforma." className="w-full">
        ...
        <div className="rounded-2xl border border-border bg-surface p-5">
          ...
          <div className="mt-4 space-y-4">
            {[
              ...
              { t: "Suporte a Clínicas", d: "Preciso que implente essas funcionalidades do plano para clínicas", s: "in_progress" },
