      ...
      <div className="p-4 sm:p-6 lg:p-8 flex flex-col items-center">
        <div className="mx-auto max-w-6xl space-y-6 text-center">
          <div>
            ...
            <h1 className="mt-2 font-display text-2xl font-bold tracking-tight text-center">
              Planos e assinatura
            </h1>
          ...
          {isLoading ? (
            ...
            <div className="rounded-2xl border border-dashed border-border bg-surface p-8 text-center text-sm text-muted-foreground mx-auto max-w-md">
              Nenhum plano disponível no momento. Fale com o suporte para liberar sua conta.
            </div>
          ) : (
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3 justify-center place-items-center">
              {plans.map((plan) => {
                ...
                return (
                  <article
                    key={plan.id}
                    className={
                      "flex flex-col rounded-2xl border bg-surface p-6 shadow-sm w-full max-w-sm h-full " +
                  ...
                  >
                    ...
                    <ul className="mt-4 space-y-2 text-sm text-left flex-1">
